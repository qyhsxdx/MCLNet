...
class SYSUData(data.Dataset):
    def __init__(self, args, data_dir, transform_train_rgb = None, transform_train_ir=None,
                 colorIndex = None, thermalIndex = None):
        #Load training images and labels
        # self.train_color_image, self.train_color_label, self.train_thermal_image, \
        # self.train_thermal_label = pre_process_sysu(args=args, data_dir=data_dir)

        self.train_color_image = np.load(data_dir + "SYSU-MM01train_rgb_resized_img.npy")
        self.train_color_label = np.load(data_dir + "SYSU-MM01train_rgb_resized_label.npy")
        self.train_thermal_image = np.load(data_dir + "SYSU-MM01train_ir_resized_img.npy")
        self.train_thermal_label = np.load(data_dir + "SYSU-MM01train_ir_resized_label.npy")
...
class RegDBData(data.Dataset):
    def __init__(self, args, data_dir, transform_train_rgb = None, transform_train_ir=None,
        ...
        #Load training images and labels
        self.train_color_image, self.train_color_label, self.train_thermal_image, \
        self.train_thermal_label = pre_process_regdb(args=args, data_dir=data_dir)

        # self.train_color_image = np.load(data_dir + "RegDBtrain_rgb_resized_img.npy")
        # self.train_color_label = np.load(data_dir + "RegDBtrain_rgb_resized_label.npy")
        # self.train_thermal_image = np.load(data_dir + "RegDBtrain_ir_resized_img.npy")
        # self.train_thermal_label = np.load(data_dir + "RegDBtrain_ir_resized_label.npy")
