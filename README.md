### Multi-level Contrastive Learning with Hierarchical Knowledge Synergy for Visible-Infrared Person Re-identification

Pytorch Code of MCLNet for VI-ReID on SYSU-MM01dataset and RegDB dataset. 
